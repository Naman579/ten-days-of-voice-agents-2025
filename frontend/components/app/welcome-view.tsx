  ...
  ({ startButtonText, onStartCall }, ref) => {
    ...
    return (
      <div
        ...
        bg-black text-white px-10 md:px-16"
      >

        {/* LEFT SIDE — NEON GLOWING TITLE */}
        <div className="flex-1 hidden md:flex flex-col justify-center pl-10">
          <h1
            className="text-[70px] font-extrabold tracking-wide animate-pulse"
            style={{
              textShadow: `
          ...
          <p className="text-xl mt-4 opacity-80 tracking-wide">
            Your Intelligent Voice Companion
          </p>
        </div>

        {/* RIGHT SIDE — YOUR ORIGINAL CARD */}
                ...
                <div className="flex w-full gap-2">
                  ...
                  <Button
                    ...
                    className="px-6 rounded-xl font-bold uppercase
                      ...
                      shadow-lg transform hover:scale-[1.03] transition-all"
                  >
