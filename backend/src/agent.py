...
# -------------------------
# Simple Product Catalog (Amazon.com)
# -------------------------
...
class GameMasterAgent(Agent):
    def __init__(self):
        ...
        instructions = """
        You are 'Alex', the friendly shopkeeper and voice assistant for Amazon.com.
...
async def entrypoint(ctx: JobContext):
    ...
    logger.info("\n" + "🛍️" * 6)
    logger.info("🚀 STARTING VOICE E-COMMERCE AGENT (Dr Abhishek Shop) — Alex")
